...
const Toast = ({ message, type, update }) => {
    return (
        <div className="flex flex-col justify-center toast">
            {type == 'success' ? (<div className="bg-green-500 shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3" id="static-example" role="alert" aria-live="assertive" aria-atomic="true" data-mdb-autohide="false">
                <div className="bg-green-500 flex justify-between items-center py-2 px-3 bg-clip-padding border-b border-green-400 rounded-lg">
                    <p className="font-bold text-white flex items-center">
                        ...
                        {message}</p>
                    <button className='text-white text-lg' onClick={() => update(false)}>
                        <AiOutlineClose />
                    </button>
                </div>

            </div>) : (<div className="bg-red-600 shadow-lg mx-auto w-96 max-w-full text-sm pointer-events-auto bg-clip-padding rounded-lg block mb-3" id="static-example" role="alert" aria-live="assertive" aria-atomic="true" data-mdb-autohide="false">
